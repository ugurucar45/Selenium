...
public class Task {
    ...
    /*)1)First of all navigate to website "https://www.etsy.com/' - DONE
       2)take care of your TestBase -DONE
       ...
       5)Your search name(iphone 13 case) should come from Parameter.xml.xml
