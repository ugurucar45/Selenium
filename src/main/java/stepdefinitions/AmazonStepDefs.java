...
public class AmazonStepDefs {
    ...
    public void i_navigate_to_amazon_com() {
    ...
    public void i_search_for_iphone_case() {
        ...
        searchButton.sendKeys("iphone 13 case", Keys.ENTER);
    }
    ...
    public void i_validate_the_search_result_number() {
        WebElement resultNum=driver.findElement(By.xpath("//span[contains(text(),'1-16 of over 30,000 results for')]"));
        String[] resultsArr=resultNum.getText().trim().split(" ");
